...
export default function EventsGrid() {
  ...
  const activeIndex = timelineTenures.findIndex(
    (t) => t.id === tenure
  );

  const progressScale =
    nodeCount > 1
      ? 1 - activeIndex / (nodeCount - 1)
      : 1;
      ...
      <Container>
                        ...
                        <p
                          className={`
                            ...
                            ${
                              isActive
                                ? "text-brand-700"
                                : "text-heading/70 group-hover:text-brand-700"
                            }
                          `}
                        >
                          {item.label}
        ...
        {filteredEvents.length > 0 ? (
          ...
          >
            <CalendarX
              size={36}
              className="text-brand-400 sm:hidden"
            />

            <CalendarX
              size={40}
              className="hidden text-brand-400 sm:block"
            />
